...
extension WMTarget {
    ...
    public static let mainHomeFeatureProjectName: String = "MainHomeFeature"
    
    private static let featureFolderName: String = "MainHome"
    private static let sampleAppFolderName: String = "SampleApp"
    
    public static func mainHomeFeature() -> WMTarget {
        let targetName = "MainHome"
        return .templateDynamicFrameworkTarget(name: targetName,
                                               projectName: Self.mainHomeFeatureProjectName,
...
//                                                .spm(name: "GoogleMobileAds"),
    ...
    public static func mainHomeUnitTest() -> WMTarget {
        let targetName = "MainHomeUnitTest"
    ...
    public static func mainHomeSampleApp() -> WMTarget {
        let targetName = "MainHomeSampleApp"
