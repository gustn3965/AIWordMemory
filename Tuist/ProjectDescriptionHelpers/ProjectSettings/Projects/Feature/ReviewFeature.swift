...
// MARK: - Review Feature
extension WMTarget {
    public static let reviewFeatureProjectName: String = "ReviewFeature"
    
    public static func reviewFeature() -> WMTarget {
        let targetName = "Review"
        return .templateDynamicFrameworkTarget(name: targetName,
                                               projectName: Self.reviewFeatureProjectName,
                                               infoPlist: defaultInfoPlist,
                                               sources: [.path("Review/Sources/**")],
                                               resources: [.path("Review/Resources/**")],
    ...
    public static func reviewUnitTest() -> WMTarget {
        let targetName = "ReviewUnitTest"
        return .templateUnitTest(name: targetName,
                                 projectName: Self.reviewFeatureProjectName,
                                 infoPlist: defaultInfoPlist,
                                 sources: [.path("Review/Tests/**")],
    ...
    public static func reviewSampleApp() -> WMTarget {
        let targetName = "ReviewSampleApp"
        return .templateAppTarget(name: targetName,
                                  projectName: Self.reviewFeatureProjectName,
                                  infoPlist: defaultInfoPlist,
                                  sources: [.path("SampleApp/Sources/**")],
                                  resources: [.path("SampleApp/Resources/**")],
                                  settings: ProjectDescriptionHelpers.reviewSampleApp(targetName),
                                  dependencies: [
                                    .currentTarget(target: .reviewFeature()),
                                    .currentTarget(target: .aiInterfaceService()),
                                    .currentTarget(target: .dbInterfaceService()),
...
private func reviewSampleApp(_ targetName: String) -> WMSettings {
    ...
    configs.forEach { config in
        ...
        let settings = mtBaseVersioning
            ...
            .merging(baseReviewProductSetting(by: config, targetName))
            .merging(appReviewSettings(by: config, targetName))
...
private func baseReviewProductSetting(by config: WMConfiguration, _ targetName: String) -> WMSettingsDictionary {
    [
...
private func appReviewSettings(by config: WMConfiguration, _ targetName: String) -> WMSettingsDictionary {
    switch config {
    case .mockDebug:
        [
